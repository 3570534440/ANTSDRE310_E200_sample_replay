...
Through the playback function, the original wireless signal characteristics, including modulation scheme, spectral shape, and time-domain structure, can be reproduced in an experimental environment.
